# -*- coding: utf-8 -*-
#
# Desarrollo web en entorno servidor documentation build configuration file, created by
...
project = u'Desarrollo web en entorno servidor'
...
htmlhelp_basename = 'Desarrollowebenentornoservidordoc'
...
# the title page.
latex_logo = 'source/php-cover.png'
